...
describe('utils functions', () => {
  ...
  test('check the takeRandomWords function', () => {
  ...
  test('check the getNecessaryWords function', () => {
  ...
  test('check the shuffle function', () => {
  ...
  test('check the getRandomAnswers function', () => {
  ...
  test('check the definePerformanceCoefficient function', () => {
